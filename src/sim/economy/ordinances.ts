...
export const ORDINANCES: OrdinanceDef[] = [
  { id: 'smoke_detectors', name: 'Smoke Detector Program', description: 'Free smoke detectors for every home and business.', fixed: 25, perCapita: 0.02,
    unlockPop: 500, effects: { 'fire.risk': 0.75 }, effectText: '−25% fire risk' },
  { id: 'rubble_cleanup', name: 'Municipal Demolition Crews', description: 'City crews clear burnt-out rubble automatically so lots can rebuild.', fixed: 100, perCapita: 0.005,
    unlockPop: 1000, effects: { 'add.rubble.cleanup': 1 }, effectText: 'Rubble auto-cleared after 30 days' },
  { id: 'neighborhood_watch', name: 'Neighborhood Watch', description: 'Residents keep an eye out for each other.', fixed: 20, perCapita: 0.015,
    unlockPop: 1500, effects: { 'crime.rate': 0.9, 'add.approval': 1 }, effectText: '−10% crime, +1 approval' },
  { id: 'youth_curfew', name: 'Youth Curfew', description: 'Minors must be home by 10pm.', fixed: 10, perCapita: 0.015,
    unlockPop: 2500, effects: { 'crime.rate': 0.9, 'add.approval': -1, 'add.desir.R3': -0.01 }, effectText: '−10% crime, −1 approval' },
  { id: 'legalized_gambling', name: 'Legalized Gambling', description: 'Allow casinos and betting. Brings money — and crime.', fixed: 0, perCapita: 0.08, income: true,
    unlockPop: 3000, effects: { 'crime.rate': 1.15, 'add.approval': -2 }, effectText: '+$0.08/resident income, +15% crime, unlocks casinos' },
  { id: 'pro_reading', name: 'Pro-Reading Campaign', description: 'Libraries and schools promote reading.', fixed: 30, perCapita: 0.02,
    unlockPop: 3000, effects: { 'edu.effect': 1.1 }, effectText: '+10% education effectiveness' },
  { id: 'free_clinics', name: 'Free Clinics', description: 'Free medical care for low-income residents.', fixed: 50, perCapita: 0.03,
    unlockPop: 5000, effects: { 'health.effect': 1.15, 'add.desir.R1': 0.04 }, effectText: '+15% health effectiveness, R$ like it' },
  { id: 'carpool', name: 'Carpool Incentive', description: 'Rewards for commuters who share rides.', fixed: 20, perCapita: 0.02,
    unlockPop: 5000, effects: { 'traffic.car': 0.93, 'pollution.air': 0.97 }, effectText: '−7% car traffic' },
  { id: 'water_conservation', name: 'Water Conservation', description: 'Low-flow fixtures and watering restrictions.', fixed: 20, perCapita: 0.02,
    unlockPop: 5000, effects: { 'water.demand': 0.8 }, effectText: '−20% water use' },
  { id: 'power_conservation', name: 'Power Conservation', description: 'Efficient appliances and lighting subsidies.', fixed: 30, perCapita: 0.03,
    unlockPop: 6000, effects: { 'power.demand': 0.85 }, effectText: '−15% power use' },
  { id: 'recycling', name: 'Recycling Program', description: 'Curbside recycling for every home.', fixed: 40, perCapita: 0.03,
    unlockPop: 8000, effects: { 'garbage.produced': 0.8 }, effectText: '−20% garbage' },
  { id: 'parking_fines', name: 'Parking Fines', description: 'Aggressive enforcement of parking rules.', fixed: 0, perCapita: 0.02, income: true,
    unlockPop: 8000, effects: { 'traffic.car': 0.97, 'add.approval': -1 }, effectText: '+$0.02/resident income, −3% car trips, −1 approval' },
  ...
  { id: 'tourism_promotion', name: 'Tourism Promotion', description: 'Advertise the city to visitors from around the world.', fixed: 300, perCapita: 0.01,
    unlockPop: 10000, effects: { 'demand.CS': 1.08, 'add.tourism': 4 }, effectText: '+8% retail demand, more tourists' },
  { id: 'pollution_controls', name: 'Industrial Pollution Controls', description: 'Scrubbers and filters required on industrial sites.', fixed: 100, perCapita: 0.015,
  ...
  { id: 'commuter_shuttle', name: 'Commuter Shuttle Service', description: 'Shuttle buses between neighborhoods and job centers.', fixed: 50, perCapita: 0.03,
    unlockPop: 15000, effects: { 'traffic.car': 0.95, 'transit.ridership': 1.1 }, effectText: '−5% car traffic, +10% transit use' },
  { id: 'clean_air_act', name: 'Clean Air Act', description: 'Strict emission limits for industry.', fixed: 200, perCapita: 0.01,
