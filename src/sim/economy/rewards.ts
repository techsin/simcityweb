...
export const REWARDS: RewardDef[] = [
  ...
  // ---------------- business deals
  { id: 'military_base', name: 'Military Base', kind: 'deal', defIds: ['rw_military_base'], conds: [pop(8000)],
    description: 'The army pays well — but it is noisy.', announce: 'The Defense Department offers a deal: host a Military Base for $2,500/month. Find it under Rewards & Deals.' },
  { id: 'missile_range', name: 'Missile Test Range', kind: 'deal', defIds: ['rw_missile_range'], conds: [pop(20000)],
    description: 'Big income, bad neighbour.', announce: 'An aerospace contractor offers $4,000/month for a Missile Test Range. Residents will hate it.' },
  { id: 'toxic_dump', name: 'Toxic Waste Dump', kind: 'deal', defIds: ['rw_toxic_dump'], conds: [pop(35000)],
    description: 'Huge income, horrible pollution.', announce: 'A chemical conglomerate offers $6,000/month to dump toxic waste here. Are you that desperate?' },
