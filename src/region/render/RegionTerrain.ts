...
export function makeLighting(kind: 'day' | 'sunset'): Lighting {
  if (kind === 'sunset')
    return {
      sunDir: sunVec(200, 7.5),
      sunColor: col('#ffb77a', 2.6),
      skyAmb: col('#7d8cc4', 0.55),
      groundAmb: col('#6b4a3a', 0.32),
      fogColor: col('#c98d7e', 0.9),
      fogSunColor: col('#ffc38a', 1.25),
      fogDensity: 1 / 26000,
      fogHeight: 900,
      skyHorizon: col('#ffb48a', 1.05),
      skyZenith: col('#1f3263', 0.9),
      glow: col('#ff8c4a', 1.1),
      cloudLit: col('#ffc2a0', 1.1),
      cloudShade: col('#6c5a80', 0.8),
      windows: col('#ffc27a', 2.4),
      night: 0.85,
      exposure: 1.05,
    };
  return {
