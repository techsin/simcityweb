...
const P: Record<string, string> = {
  ...
  next: '<path d="M18 5v14"/><path d="M5 5.5v13L15 12z" fill="currentColor" stroke-linejoin="round"/>',
  shuffle: '<path d="M3 7h3.5c3 0 4.5 2 6 5s3 5 6 5H21"/><path d="M3 17h3.5c1.4 0 2.5-.5 3.4-1.3M21 7h-2.5c-1.4 0-2.5.5-3.4 1.3"/><path d="m18.5 4.5 2.5 2.5-2.5 2.5M18.5 14.5l2.5 2.5-2.5 2.5"/>',
  playFill: '<path d="M7.5 4.8v14.4L19.5 12z" fill="currentColor" stroke-linejoin="round"/>',
  pauseFill: '<rect x="6.5" y="5" width="3.8" height="14" rx="1" fill="currentColor" stroke="none"/><rect x="13.7" y="5" width="3.8" height="14" rx="1" fill="currentColor" stroke="none"/>',
